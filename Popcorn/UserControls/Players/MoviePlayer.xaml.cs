...
namespace Popcorn.UserControls.Players
{
    ...
    public partial class MoviePlayer
    {
        ...
        /// </summary>
        internal static readonly DependencyProperty MediaPlayerIsPlayingProperty = DependencyProperty.Register("MediaPlayerIsPlaying", typeof(bool), typeof(MoviePlayer), new PropertyMetadata(false, null));
        #endregion
        ...
        /// Identifies the <see cref="MediaPlayerIsPlaying"/> dependency property. 
        /// </summary>
        internal static readonly DependencyProperty VolumeProperty = DependencyProperty.Register("Volume", typeof(int), typeof(MoviePlayer), new PropertyMetadata(100, OnVolumeChanged));
        #endregion
