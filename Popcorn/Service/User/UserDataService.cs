...
namespace Popcorn.Service.User
{
    ...
    public class UserDataService : IUserDataService
    {
        ...
        public async Task<Model.Account.User> CreateUser(string username, string firstname, string lastname,
            string password, string email, CancellationToken ct)
        {
            ...
            var user =
                await Task.Run(() => JsonConvert.DeserializeObject<Model.Account.User>(response.Content), ct);
        ...
        public async Task<Bearer> Signin(Model.Account.User user, CancellationToken ct)
        {
            var watch = Stopwatch.StartNew();
